...
if (!isset($_SESSION['username']) && !isset($_SESSION['password'])) {
	...
	<body>
		...
		<main>
			<div class="row">
				<div class="col">
					<div class="border p-3 my-3 bg-info text-light rounded">
			...
			<?= isset($_POST['tgl']) ? "<a href='reportprint.php?np=$np&tgl=$tgl' target='blank' class='btn btn-primary'><i class='fas fa-print'></i> Cetak Laporan</a>" : '' ?>
			</div>
		</main>
		<br><br>
