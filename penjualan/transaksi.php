...
<body>
	...
	<main>
		...
		<div class="row">
			<div class="col-sm-8">
				...
				if (!isset($_SESSION['bayar'])) {
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="d-grid">
								<a href="produk.php" class="btn btn-success btn-block">
							...
							while ($data = mysqli_fetch_array($result)) {
								...
								<tr>
									...
									<td align="right">
										...
										if (isset($_SESSION['bayar'])) {
											?>
											<a href="" class="btn btn-success btn-sm disabled"><i class="fas fa-edit"></i></a>
											<a class="btn btn-danger btn-sm disabled"><i class="fas fa-trash-alt"></i></a>
											<?php
										} else {
											?>
											<a href="" class="btn btn-success btn-sm" data-bs-toggle="modal"
												data-bs-target="#modaledit<?= $data['detail_id'] ?>">
			...
			<!-- akhir modal Form -->
			<div class="col-md-4">
				<div class="container border p-2 bg-danger text-light rounded mb-2">
					<div class="row">
						<div class="col-4">Jumlah Total :</div>
						<div class="col-8">
							<h1 style="font-size:4vw; text-align: right"><?= $jmltotal ?>,-</h1>
						</div>
					</div>
				</div>
				<?php
				if (isset($_SESSION['bayar'])) {
					...
					?>
					<div class="container border p-2 bg-light text-dark rounded mb-2">
						<div class="row align-items-center">
							<div class="col-4">
								<h4 class="m-0">Bayar:</h4>
							</div>
							<div class="col-8">
								<h1 class="text-success text-end" style="font-size: 3vw;"><?= $byr ?>,-</h1>
							</div>
						</div>
					</div>
					...
					<div class="container border p-2 bg-light text-dark rounded mb-2">
						<div class="row align-items-center">
							...
							<div class="col-8">
								<h1 class="text-warning text-end" style="font-size: 3vw;"><?= $kbl ?>,-</h1>
							</div>
						</div>
					</div>
					...
					<div class="row mb-3">
						<div class="col-6">
							<div class="d-grid">
								<a href="selesai.php" class="btn btn-success btn-lg" style="font-size: 1.5rem;">
						...
						<div class="col-6">
							<div class="d-grid">
								<a href="printbyr.php" target="cetak-nota" class="btn btn-secondary btn-lg"
