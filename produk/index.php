						...
						<tr>
							...
							<td align="right">
								...
								<a href="" class="btn btn-success btn-sm" data-bs-toggle="modal"
									data-bs-target="#modaledit<?= $data['id_produk'] ?>">
								...
								<a class="btn btn-danger btn-sm" href="delete.php?id=<?= $data['id_produk'] ?>"
									...
									class="hapus"><i class="fas fa-trash"></i> hapus
								</a>
									...
									<form method="POST" action="update.php?halaman=<?= $halaman ?>">
										...
										<div class="modal-body">
											...
											<div class="row mb-3">
												...
												<div class="col-md-8">
													<input type="text" id="namaProduk" name="np" class="form-control"
											...
											<div class="row mb-3">
												...
												<div class="col-md-8">
													<input type="text" id="harga" name="hp" class="form-control"
											...
											<div class="row mb-3">
												...
												<div class="col-md-8">
													<input type="text" id="stok" name="sp" class="form-control"
								...
								<div class="row">
									<div class="col-4 text-start py-3">
										...
										<button type="button" class="btn btn-primary" data-bs-toggle="modal"
											...
											<i class="fas fa-plus"></i> Data Produk
										</button>
