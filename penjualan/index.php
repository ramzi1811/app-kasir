					...
					<div class="row">
						...
						<div class="col-sm-4">
							<form class="d-flex" method="GET" action="">
								<input class="form-control me-2 shadow-sm" type="date" name="tgl" style="border-radius: 5px;">
								<button class="btn btn-primary shadow-sm" type="submit" style="border-radius: 5px;">
					...
					<table class="table table-hover table-striped table-sm">
						<thead class=" text-dark" style="background-color: #adffc6; color: white;">
							<tr>
								...
								<th class="py-2 px-3" width="150px">Pelanggan</th>
								<th class="py-2" width="150px">Petugas</th>
								<th class="py-2 text-center rounded-end" width="250px">Aksi</th>
							</tr>
						</thead>
						<tbody>
							<?php
									...
									<div class="container">
										<div class="row">
											<div class="col-4 text-start py-3">
												...
												<a class="btn btn-primary" href="penjualan_simpan.php">
