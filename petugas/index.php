						...
						<tr>
							...
							<td align="right">
								<a href="" class="btn btn-success btn-sm" data-bs-toggle="modal"
									data-bs-target="#modaledit<?= $data['id_petugas'] ?>"><i class="fas fa-edit"></i>edit</a>

								<a class="btn btn-danger btn-sm" href="delete.php?id=<?= $data['id_petugas'] ?>"
									onclick="return confirm('Apakah Anda Yakin data Petugas <?= $data['nama_petugas'] ?> akan dihapus ?')"
								...
								<div class="row">
									<div class="col-4 text-start py-3">
										...
										<button type="button" class="btn btn-primary" data-bs-toggle="modal"
											...
											<i class="fas fa-plus"></i> Data Petugas
										</button>
