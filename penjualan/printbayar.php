...
<body style="padding:5px 10px; width:3.75in; font:9pt 'consolas';">
	...
	<table width="100%" cellspacing="0">
		<tr>
			...
			<td align="right" class="brs" style="padding:2px 5px; border-top: 1px solid;">Penjualan ID : <?= $penid ?>
			</td>
		</tr>
		<tr>
	...
	<table width="100%" cellspacing="0">
		...
		?>
		<tr>
			<td colspan="2" class="brs" align="right"
				style="padding:5px 5px; border-bottom: 1px solid; border-top: 1px solid;">Total :</td>
			<th class="brs" align="right"
				style="font-size:11pt; padding:2px 5px;  border-bottom: 1px solid; border-top: 1px solid;">
				<?= $jmltotal ?>
			</th>
		</tr>
		<?php
